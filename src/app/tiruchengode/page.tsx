...
export const metadata: Metadata = {
  title: "Arts and Science College in Tiruchengode | JKKN CAS",
  ...
  keywords: [
    "colleges in tiruchengode",
    "tiruchengode college list",
    "tiruchengode best college",
    "best college in tiruchengode",
    "tiruchengode arts and science college list",
    "arts and science college in tiruchengode",
    "JKKN CAS Tiruchengode",
    "BCA college near Tiruchengode",
    "BBA college near Tiruchengode",
    "B.Com college near Tiruchengode",
    "affordable college near Tiruchengode",
  ],

  robots: "index, follow",

  alternates: {
    canonical: "https://cas.jkkn.ac.in/tiruchengode",
  },
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "JKKN College of Arts and Science — campus near Tiruchengode in Komarapalayam",
      },
    ],
  },
...
export default function TiruchengodePage() {
  const faqs = [
    ...
    },
    {
      ...
      a: "JKKN CAS is approximately 20 km from Tiruchengode, a journey of 25–35 minutes by road via the direct Tiruchengode–Komarapalayam road. Both towns are in Namakkal district, so the commute is short and familiar. Regular TNSTC and private buses run between Tiruchengode bus stand and Komarapalayam throughout the day. College transport is also available.",
    },
    {
    ...
    },
    {
      ...
      a: "Regular TNSTC government and private buses run between Tiruchengode bus stand and Komarapalayam throughout the day; the journey takes 25–35 minutes via the direct Tiruchengode–Komarapalayam road. Many students from Tiruchengode already commute daily to nearby colleges, and the JKKN campus on NH-544 at Komarapalayam is an easy addition to that routine.",
    },
    {
      q: "Are JKKN CAS fees affordable compared to Tiruchengode-area colleges?",
      a: "JKKN CAS fees are lower than most private colleges in the Tiruchengode area. Tamil Nadu government scholarships for BC, MBC, SC, and ST students are available. Merit-based concessions are also offered. Contact the admission office at +91 9345855001 for the current fee structure.",
    },
    {
      q: "Does JKKN CAS provide hostel for Tiruchengode students?",
      a: "JKKN CAS provides separate hostel accommodation for boys and girls on the main campus. The hostel includes furnished rooms, three meals per day, WiFi, and 24/7 security. At approximately 20 km, day-scholar commute from Tiruchengode is easy — just 25–35 minutes by road — so students can choose daily commute or hostel life.",
    },
    {
  ...
  const schemaFaqs = [
    {
      ...
      answer:
        "JKKN College of Arts and Science, approximately 20 km from Tiruchengode in neighbouring Komarapalayam, is a NAAC-accredited institution with 35 programmes and 90%+ placement rates. It is affiliated to Periyar University and approved by UGC.",
    },
    {
      question: "How far is JKKN CAS from Tiruchengode?",
      answer:
        "JKKN CAS is approximately 20 km from Tiruchengode, a journey of 25 to 35 minutes via the direct Tiruchengode–Komarapalayam road. Both towns are in Namakkal district, and regular TNSTC and private buses run between Tiruchengode bus stand and Komarapalayam throughout the day.",
    },
    {
      question: "Is there a direct bus from Tiruchengode to JKKN CAS?",
      answer:
        "Regular TNSTC government and private buses run between Tiruchengode bus stand and Komarapalayam throughout the day; the journey takes 25 to 35 minutes via the direct Tiruchengode–Komarapalayam road. The JKKN campus sits on NH-544 at Komarapalayam.",
    },
    {
      question: "Does JKKN CAS offer hostel facilities for students from Tiruchengode?",
      answer:
        "JKKN CAS provides separate hostel accommodation for boys and girls on the main campus, with furnished rooms, three meals per day, WiFi, and 24/7 security. At approximately 20 km, students from Tiruchengode can also comfortably commute daily.",
    },
    {
      question: "Are fees at JKKN CAS affordable compared to Tiruchengode-area colleges?",
      answer:
        "JKKN CAS fees are lower than most private colleges in the Tiruchengode area. Tamil Nadu government scholarships for BC, MBC, SC, and ST students are available. Contact the admission office at +91 9345855001 for the current fee structure.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "JKKN CAS near Tiruchengode offers BCA, BBA, B.Com, B.Sc across 8 specialisations, MCA, M.Com, M.Sc, and Ph.D programmes — 35 courses in total. All programmes are UGC-approved and affiliated to Periyar University.",
    },
    {
  ...
  return (
    <main>
      <BreadcrumbSchema items={[
        ...
        { name: "Tiruchengode", url: "https://cas.jkkn.ac.in/tiruchengode" },
      ]} />
          ...
          __html: JSON.stringify({
            ...
            "breadcrumb": {
              ...
              "itemListElement": [
                ...
                { "@type": "ListItem", "position": 2, "name": "Tiruchengode", "item": "https://cas.jkkn.ac.in/tiruchengode" }
              ]
            },
            "speakable": {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "url": "https://cas.jkkn.ac.in",
            "foundingDate": "1974",
            "description": "JKKN College of Arts and Science is a NAAC-accredited institution on NH-544 at Komarapalayam, approximately 20 km from Tiruchengode, offering 34 UG, PG, and Ph.D programmes in arts, science, commerce, and computer applications, affiliated to Periyar University.",
      ...
      <CourseSchema
        ...
        description="3-year undergraduate science programme with specialisations in Chemistry, Mathematics, Zoology, Physics, Microbiology, Computer Science, and more at JKKN CAS near Tiruchengode."
        duration="PT3Y"
        educationalLevel="UG"
        category="Aided"
      ...
      <CourseSchema
        ...
        description="3-year undergraduate commerce programme with strong industry exposure and placement support at JKKN CAS, approximately 20 km from Tiruchengode via the direct Tiruchengode–Komarapalayam road."
        duration="PT3Y"
        educationalLevel="UG"
        category="Aided"
      ...
      <CourseSchema
        ...
        description="3-year undergraduate management programme building future business leaders, offered at JKKN CAS — approximately 20 km from Tiruchengode."
        duration="PT3Y"
        educationalLevel="UG"
      ...
      <section aria-label="Hero" className="relative bg-gradient-to-br from-[#002309] via-[#006837] to-[#002309] text-white overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-20 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight mb-4">
            Arts and Science College in Tiruchengode — JKKN CAS
          </h1>

          {/* Featured Snippet Paragraph */}
          <h2 className="text-xl font-semibold text-white mb-3">
            Arts and Science College Near Tiruchengode — JKKN CAS
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=cas.jkkn.ac.in&utm_medium=organic&utm_campaign=tiruchengode"
              target="_blank"
      ...
      {/* Distance Card */}
      <section aria-label="Distance from Tiruchengode" className="bg-[#FBFBEE] py-10 sm:py-12">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 flex flex-wrap sm:flex-nowrap items-center justify-between gap-4 p-6">
            <div className="flex items-center gap-4">
              <span className="text-5xl sm:text-6xl font-bold text-[#006837] leading-none">
                20<span className="text-2xl font-semibold text-[#006837]">km</span>
              </span>
              <div>
                <div className="font-bold text-gray-800 text-base sm:text-lg">
                  From Tiruchengode to JKKN CAS
                </div>
                <div className="text-gray-500 text-sm mt-1">
                  25–35 minutes via the direct Tiruchengode–Komarapalayam road
                </div>
              </div>
            </div>
            <a
      ...
      {/* Why Tiruchengode Students Choose JKKN CAS */}
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto text-sm sm:text-base leading-relaxed">
              ...
              hill, known for its lorry-body building and borewell rig industry
              — sends many students to nearby colleges every day. JKKN is
              approximately 20 km away via the direct
              Tiruchengode–Komarapalayam road, and both towns are in Namakkal
              district, making the daily commute short and familiar.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              },
              {
                Icon: Bus,
                title: "Easy Commute",
                desc: "Just ~20 km from Tiruchengode. Daily commute or comfortable hostel — your choice.",
              },
            ].map((item) => (
              <div
                key={item.title}
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              UG &amp; PG Programmes Near Tiruchengode
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
            {[
              {
                Icon: FlaskConical,
                name: "B.Sc College Near Tiruchengode — JKKN CAS",
                duration: "3 years",
                level: "UG",
                intake: "200+ seats",
              ...
              {
                Icon: BarChart2,
                name: "B.Com College Near Tiruchengode — JKKN CAS",
                duration: "3 years",
                level: "UG",
                intake: "150 seats",
              ...
              {
                Icon: Briefcase,
                name: "BBA College Near Tiruchengode — JKKN CAS",
                duration: "3 years",
                level: "UG",
                intake: "60 seats",
              ...
              {
                Icon: Monitor,
                name: "BCA College Near Tiruchengode — JKKN CAS",
                duration: "3 years",
                level: "UG",
                intake: "60 seats",
          ...
          <div className="mt-12 pt-10 border-t border-gray-200">
            <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2 text-center">
              All 35 Programmes Available Near Tiruchengode
            </h3>
            <p className="text-gray-500 text-sm text-center mb-8">
              Searching a Tiruchengode arts and science college list? Start here —
      ...
      <section aria-label="Placement highlights" className="bg-white py-14 sm:py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              Where Tiruchengode Graduates Are Working Now
            </h2>
            <p className="text-gray-500 text-sm sm:text-base">
      ...
      {/* How to Reach from Tiruchengode */}
              ...
              {[
                {
                  Icon: MapPin,
                  label: "ROUTE",
                  info: "Direct Tiruchengode–Komarapalayam road — both towns are in Namakkal district",
                  bg: "bg-[#FBFBEE]",
                },
                {
                  Icon: Bus,
                  label: "BY BUS",
                  info: "Regular TNSTC and private buses run between Tiruchengode bus stand and Komarapalayam throughout the day",
                  bg: "bg-[#FBFBEE]",
                },
                {
                  Icon: Train,
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              },
              {
                Icon: Bus,
                title: "Transport",
                desc: "College buses connecting to Tiruchengode and surrounding areas",
                bg: "bg-[#FBFBEE]",
              },
              {
                Icon: Activity,
      ...
      {/* Comparison Table */}
      <section aria-label="Comparison with Tiruchengode colleges" className="bg-[#FBFBEE] py-14 sm:py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              Colleges in Tiruchengode — How JKKN CAS Compares
            </h2>
            <div className="mx-auto mt-4 w-12 h-1 bg-[#7cb983] rounded-full" />
          </div>
            ...
            <table className="w-full text-sm border-collapse bg-white">
              <thead>
                <tr className="bg-[#006837] text-white">
                  ...
                  <th className="p-3 text-left font-semibold">Typical Tiruchengode College</th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr className="border-b border-gray-100 bg-[#FBFBEE]">
                  <td className="p-3 text-gray-600">Distance from Tiruchengode</td>
                  <td className="p-3 text-gray-800 font-medium">~20 km via the direct road</td>
      ...
      <section id="faq-section" aria-label="Frequently asked questions" className="bg-white py-14 sm:py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 text-sm sm:text-base">
              Best College in Tiruchengode — Your Questions Answered
            </p>
            <div className="mx-auto mt-4 w-12 h-1 bg-[#7cb983] rounded-full" />
          </div>
