...
export default function BhavaniPage() {
  ...
  const schemaFaqs = [
    ...
    },
    {
      ...
      answer:
        "Applications for JKKN CAS are submitted online at admission.jkkn.ac.in or in person at the campus admission office, a short ride from Bhavani across the Cauvery bridge. Admissions for 2026–27 are currently open. Call +91 9345855001 for guidance.",
    },
    {
    ...
    <main>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
              Why Students from Bhavani Prefer JKKN CAS
            </h2>
      ...
      <section className="bg-[#FBFBEE] py-14 sm:py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              Students from Bhavani Love JKKN CAS
            </h2>
            <p className="text-gray-500 text-sm sm:text-base">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100">
              ...
              <p className="text-gray-500 text-sm leading-relaxed italic">
                [Student testimonial from Bhavani to be added here. Include their
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100">
              ...
              <p className="text-gray-500 text-sm leading-relaxed italic">
                [Second student testimonial from Bhavani to be added here. Focus
            ...
            <div className="rounded-2xl p-6 border-2 border-dashed border-[#7cb983] bg-[#FBFBEE] flex items-center justify-center">
              <p className="text-[#006837] text-sm font-medium text-center leading-relaxed">
                Add 2-3 real student testimonials from Bhavani or nearby areas
                before deployment.
              </p>
            </div>
          </div>
