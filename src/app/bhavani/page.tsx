  ...
  return (
    <main>
      ...
      <CourseSchema
        ...
        description="3-year undergraduate IT programme with hands-on training and a placement record published in NIRF 2025 at JKKN CAS, easily reachable from Bhavani."
        duration="PT3Y"
        educationalLevel="UG"
        category="Self-Finance"
