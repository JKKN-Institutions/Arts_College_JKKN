    ...
    sections: [
      {
        children: [
          ...
          p('3. Strong Placement Record — placement record published in NIRF 2025 with 60+ recruiting companies.'),
          ...
          p("A: JKKN CAS has a placement record published in NIRF 2025 with 60+ recruiting companies. The Training and Placement Cell organizes on-campus recruitment drives, internships, and career guidance sessions throughout the academic year."),
          p(''),
