          ...
          <RevealSection>
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=cas.jkkn.ac.in&utm_medium=organic&utm_campaign=programmes-self-finance-pg-msc-computer-science" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-brand-green hover:bg-brand-green/90 text-white px-7 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
                  Apply Now
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              {[
                ...
                { question: 'What is the fee structure for M.Sc Computer Science?', answer: 'The annual fee for M.Sc Computer Science is ₹25,000 under Management Quota (MQ). Government Quota (GQ) fees are As Per Norms. Scholarships are available for meritorious students and those from economically weaker sections. Government scholarships and educational loans are also facilitated through the institution.' },
