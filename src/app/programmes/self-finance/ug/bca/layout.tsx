  ...
  return (
    <>
      ...
      <FAQSchema faqs={[
        ...
        { question: "Is there placement support?", answer: "Yes, we have a dedicated placement cell with a placement record published in NIRF 2025. Top recruiters include TCS, Infosys, Wipro, Cognizant, Accenture, and various startups and product-based companies." },
