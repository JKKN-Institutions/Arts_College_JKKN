  ...
  return (
    <>
      ...
      <FAQSchema faqs={[
        ...
        { question: "What is the average salary package for B.Sc TFD graduates?", answer: "Entry-level salaries range from ₹2.5-4.5 lakhs per annum depending on the role and company. Fashion designers in established brands can earn ₹4-8 lakhs, while merchandisers and production managers earn ₹3-6 lakhs annually. Successful entrepreneurs and freelance designers can earn significantly higher based on their clientele and brand value." },
