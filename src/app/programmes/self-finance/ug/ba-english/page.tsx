...
import { BookOpen, Users, Award, Briefcase, GraduationCap, Lightbulb, CheckCircle2, Clock, FileText, Globe, ChevronDown, ArrowRight, Sparkles, Target, Pen, Mic } from 'lucide-react';
...
export default function SFBAEnglishPage() {
          ...
          <RevealSection>
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=cas.jkkn.ac.in&utm_medium=organic&utm_campaign=programmes-self-finance-ug-ba-english" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-brand-green hover:bg-brand-green/90 text-white px-7 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
                  Apply Now
          ...
          <div className="max-w-6xl mx-auto grid lg:grid-cols-5 gap-8 items-center">
            <RevealSection className="lg:col-span-3">
              ...
              <p className="text-lg text-gray-700 mb-4 leading-relaxed">
                The Bachelor of Arts in English (Self-Finance) is a comprehensive three-year undergraduate programme designed to develop proficient communicators, critical thinkers, and creative writers. Offered under the self-finance stream, this programme provides the same rigorous academic foundation as its aided counterpart, with an in-depth exploration of English literature spanning various periods, genres, and cultural contexts alongside strong foundations in language studies, linguistics, and professional communication.
              </p>
            ...
            <RevealSection>
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  Requirements for joining the BA English (Self-Finance) programme
                </p>
              </div>
            </RevealSection>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
              {[
                ...
                { icon: <Briefcase className="w-6 h-6" />, title: 'Corporate Communications', desc: 'Handle internal and external communications for corporates' },
            ...
            <RevealSection>
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600">
                  Find answers to common queries about the BA English (Self-Finance) programme
                </p>
              </div>
            </RevealSection>
          ...
          <RevealSection>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg mb-8 text-gray-600">
                Join our BA English (Self-Finance) programme and unlock a world of opportunities in literature, language, and communication.
              </p>

              <div className="flex flex-wrap justify-center gap-4 mb-8">
                <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=cas.jkkn.ac.in&utm_medium=organic&utm_campaign=programmes-self-finance-ug-ba-english" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-gradient-to-r from-brand-green to-emerald-500 hover:from-brand-green/90 hover:to-emerald-500/90 text-white px-8 py-4 rounded-lg font-semibold shadow-xl shadow-brand-green/25 hover:shadow-2xl transition-all hover:-translate-y-1">
                  Apply for Admission
                  <ArrowRight className="w-4 h-4" />
                </a>
