          ...
          <RevealSection>
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=cas.jkkn.ac.in&utm_medium=organic&utm_campaign=programmes-aided-ug-bsc-zoology" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-brand-green hover:bg-emerald-600 text-white px-7 py-3 rounded-lg font-semibold shadow-xl hover:shadow-2xl transition-all hover:-translate-y-1">
                  Apply Now
