          ...
          <RevealSection>
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=cas.jkkn.ac.in&utm_medium=organic&utm_campaign=programmes-aided-ug-bcom" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-brand-green hover:bg-brand-green/90 text-white px-7 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
                  Apply Now
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              {[
                ...
                { question: 'What makes this B.Com programme different from others?', answer: 'Our B.Com programme stands out due to its industry-aligned curriculum, integrated CA/CMA foundation coaching, state-of-the-art computer and finance labs, experienced Senior Learners with industry expertise, strong placement cell with a placement record published in NIRF 2025, and partnerships with leading CA firms, banks, and corporates for internships. We also offer specializations in Accounting & Finance, Taxation, Banking & Insurance, and Business Analytics.' },
