          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              {[
                ...
                { question: 'Does the college provide placement assistance for Physics graduates?', answer: 'Yes, our dedicated Placement Cell actively supports M.Sc Physics Learners through campus recruitment drives, industry interaction sessions, and research internship opportunities. We have partnerships with organizations like ISRO, DRDO, IT companies, and academic institutions. The placement rate for M.Sc Physics graduates is not published separately; the NIRF 2025 return for this college reports a median salary of Rs. 4,00,000 for placed UG graduates in 2023-24.' },
