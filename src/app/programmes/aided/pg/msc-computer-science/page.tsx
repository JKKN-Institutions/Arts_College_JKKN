            ...
            <RevealSection delay={200}>
              ...
              <div className="space-y-4">
                {[
                  ...
                  { title: 'Exceptional Placement Support', description: 'Dedicated placement cell with year-round training and campus recruitment for data science roles.' }
                ].map((reason, idx) => (
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              {[
                ...
                { question: 'What is the placement scenario for M.Sc Data Analytics graduates?', answer: 'The Placement Cell supports M.Sc graduates into Data Analyst and related roles; batch-wise placement and salary data is available from the Placement Cell. Machine Learning Engineers and Data Scientists command packages of ₹8-15 lakhs. Top performers have secured positions at companies like TCS, Infosys, Wipro, Accenture, and tech startups with packages exceeding ₹12 lakhs. The highest package recorded was ₹12 LPA.' },
