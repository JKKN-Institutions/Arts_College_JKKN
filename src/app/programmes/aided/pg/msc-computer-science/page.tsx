          ...
          <RevealSection>
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <a href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=cas.jkkn.ac.in&utm_medium=organic&utm_campaign=programmes-aided-pg-msc-computer-science" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-brand-green hover:bg-brand-green/90 text-white px-7 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
                  Apply Now
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">
            {[
              ...
              { icon: <Briefcase className="w-7 h-7" />, stat: '90%+', title: 'Placement Record', desc: 'Industry-ready graduates' },
            ...
            <RevealSection delay={200}>
              ...
              <div className="space-y-4">
                {[
                  ...
                  { title: 'Exceptional Placement Support', description: 'Dedicated placement cell with 90%+ placement record and average packages of ₹6-8 LPA for data science roles.' }
                ].map((reason, idx) => (
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              {[
                ...
                { question: 'What is the placement scenario for M.Sc Data Analytics graduates?', answer: 'Our M.Sc Data Analytics programme boasts a 90%+ placement record. Entry-level packages range from ₹4.5 to ₹8 lakhs per annum for Data Analyst roles. Machine Learning Engineers and Data Scientists command packages of ₹8-15 lakhs. Top performers have secured positions at companies like TCS, Infosys, Wipro, Accenture, and tech startups with packages exceeding ₹12 lakhs. The highest package recorded was ₹12 LPA.' },
