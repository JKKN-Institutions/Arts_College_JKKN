          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              {[
                ...
                { question: 'What is the placement support for M.Sc Chemistry?', answer: 'Our placement cell actively connects students with pharmaceutical companies, chemical industries, research laboratories, and quality control labs. We also provide training for CSIR-NET, GATE,Competitive exams and conducted hands on training, supported by ours MOU companies/Lab. For 2023-24 the college reported 135 of 373 UG graduates placed across all programmes (NIRF 2025); it does not publish a separate M.Sc Chemistry rate.' }
              ].map((faq, idx) => (
