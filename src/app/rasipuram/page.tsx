...
export default function RasipuramPage() {
  ...
  const schemaFaqs = [
    ...
    },
    {
      ...
      answer:
        "JKKN CAS near Rasipuram offers BCA, BBA, B.Com, B.Sc across 8 specialisations, MCA, M.Com, M.Sc, and Ph.D programmes — 34 courses in total. All programmes are UGC-approved and affiliated to Periyar University or Bharathiar University.",
    },
    {
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="mt-12 pt-10 border-t border-gray-200">
            <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2 text-center">
              All 34 Programmes Available Near Rasipuram
            </h3>
