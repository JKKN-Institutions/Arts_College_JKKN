...
export const metadata: Metadata = {
  ...
  keywords: [
    "arts and science college near rasipuram",
    "colleges near rasipuram",
    "best arts and science college in namakkal district",
    "college with hostel near rasipuram",
    "JKKN CAS Rasipuram",
    "BCA college near Rasipuram",
    "BBA college near Rasipuram",
    "B.Com college near Rasipuram",
    "degree college near Rasipuram",
  ],

  robots: "index, follow",

  alternates: {
    canonical: "https://cas.jkkn.ac.in/rasipuram",
  },
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "JKKN College of Arts and Science — campus near Rasipuram on NH-544",
      },
    ],
  },
...
export default function RasipuramPage() {
  const faqs = [
    ...
    },
    {
      ...
      a: "JKKN CAS is approximately 60 km from Rasipuram, about 1 hour 15 minutes by road via Tiruchengode to Komarapalayam. The campus sits on NH-544 at Natarajapuram. Because of the distance, most students from Rasipuram choose to stay in the campus hostel rather than commute daily.",
    },
    {
      q: "Is there a college with hostel near Rasipuram?",
      a: "Yes — JKKN CAS provides separate hostels for boys and girls on the main campus, and this is exactly why most Rasipuram students choose it. At approximately 60 km from Rasipuram, staying in the hostel is far more practical than a daily commute. The hostel includes furnished rooms, three meals per day, WiFi, and 24/7 security.",
    },
    {
      q: "What hostel facilities does JKKN CAS offer for Rasipuram students?",
      a: "The JKKN CAS campus hostel offers furnished rooms, three meals per day, WiFi, and 24/7 security, with separate blocks for boys and girls. Living on campus means zero travel time, more study hours, and full access to the library, labs, and sports facilities. Hostel booking is done at the enrollment stage.",
    },
    {
      q: "Which courses are popular among Rasipuram students at JKKN CAS?",
      a: "JKKN CAS near Rasipuram offers BCA, BBA, B.Com, B.Sc across 8 specialisations, MCA, M.Com, M.Sc, and Ph.D programmes — 35 courses in total. All programmes are UGC-approved and affiliated to Periyar University. BCA and B.Com are the most popular among students from the Rasipuram region.",
    },
    {
      q: "Are JKKN CAS fees affordable for students from Rasipuram?",
      a: "JKKN CAS fees are lower than most city-based private colleges. Tamil Nadu government scholarships for BC, MBC, SC, and ST students are available. Merit-based concessions are also offered. Contact the admission office at +91 9345855001 for the current fee and hostel fee structure.",
    },
    {
  ...
  const schemaFaqs = [
    {
      ...
      answer:
        "JKKN College of Arts and Science, in the same Namakkal district approximately 60 km from Rasipuram, is a NAAC-accredited institution with 34 programmes, 90%+ placement rates, and campus hostels. It is affiliated to Periyar University and approved by UGC.",
    },
    {
      question: "How far is JKKN CAS from Rasipuram?",
      answer:
        "JKKN CAS is approximately 60 km from Rasipuram, about 1 hour 15 minutes by road via Tiruchengode to Komarapalayam. The campus sits on NH-544, and most Rasipuram students choose to stay in the campus hostel rather than commute daily.",
    },
    {
      question: "Is there a college with hostel near Rasipuram?",
      answer:
        "Yes — JKKN CAS provides separate hostels for boys and girls on the main campus. At approximately 60 km from Rasipuram, staying in the hostel is more practical than a daily commute. The hostel includes furnished rooms, three meals per day, WiFi, and 24/7 security.",
    },
    {
      question: "What hostel facilities does JKKN CAS offer for Rasipuram students?",
      answer:
        "The JKKN CAS campus hostel offers furnished rooms, three meals per day, WiFi, and 24/7 security, with separate blocks for boys and girls. Living on campus means zero travel time and full access to the library, labs, and sports facilities.",
    },
    {
      question: "Which courses are popular among Rasipuram students at JKKN CAS?",
      answer:
        "JKKN CAS near Rasipuram offers BCA, BBA, B.Com, B.Sc across 8 specialisations, MCA, M.Com, M.Sc, and Ph.D programmes — 35 courses in total. All programmes are UGC-approved and affiliated to Periyar University.",
    },
    {
      question: "Are JKKN CAS fees affordable for students from Rasipuram?",
      answer:
        "JKKN CAS fees are lower than most city-based private colleges. Tamil Nadu government scholarships for BC, MBC, SC, and ST students are available. Contact the admission office at +91 9345855001 for the current fee and hostel fee structure.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "JKKN CAS is NAAC-accredited with 35 programmes and 90%+ placements with national recruiters. For Rasipuram students, the full residential campus with separate boys and girls hostels makes the approximately 60 km distance a non-issue.",
    },
  ];
  ...
  return (
    <main>
      <BreadcrumbSchema items={[
        ...
        { name: "Rasipuram", url: "https://cas.jkkn.ac.in/rasipuram" },
      ]} />
          ...
          __html: JSON.stringify({
            ...
            "breadcrumb": {
              ...
              "itemListElement": [
                ...
                { "@type": "ListItem", "position": 2, "name": "Rasipuram", "item": "https://cas.jkkn.ac.in/rasipuram" }
              ]
            },
            "speakable": {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "url": "https://cas.jkkn.ac.in",
            "foundingDate": "1974",
            "description": "JKKN College of Arts and Science is a NAAC-accredited institution on NH-544 at Komarapalayam in Namakkal district, approximately 60 km from Rasipuram, offering 34 UG, PG, and Ph.D programmes in arts, science, commerce, and computer applications with boys and girls hostels, affiliated to Periyar University.",
      ...
      <CourseSchema
        ...
        description="3-year undergraduate science programme with specialisations in Chemistry, Mathematics, Zoology, Physics, Microbiology, Computer Science, and more at JKKN CAS near Rasipuram."
        duration="PT3Y"
        educationalLevel="UG"
        category="Aided"
      ...
      <CourseSchema
        ...
        description="3-year undergraduate commerce programme with strong industry exposure and placement support at JKKN CAS, with hostel facilities for students from Rasipuram."
        duration="PT3Y"
        educationalLevel="UG"
        category="Aided"
      ...
      <CourseSchema
        ...
        description="3-year undergraduate management programme building future business leaders, offered at JKKN CAS — approximately 60 km from Rasipuram in Namakkal district."
        duration="PT3Y"
        educationalLevel="UG"
      ...
      <section aria-label="Hero" className="relative bg-gradient-to-br from-[#002309] via-[#006837] to-[#002309] text-white overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-20 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight mb-4">
            Arts and Science College near Rasipuram — JKKN CAS
          </h1>

          {/* Featured Snippet Paragraph */}
          <h2 className="text-xl font-semibold text-white mb-3">
            Best Arts and Science College in Namakkal District — With Hostel
          </h2>
          <p className="snippet-answer-paragraph text-base sm:text-lg text-white/80 max-w-2xl mx-auto mb-6 leading-relaxed">
            JKKN College of Arts and Science, located on NH-544 in the same
            Namakkal district approximately 60 km from Rasipuram, is a
            ...
            boys and girls hostels on campus. Affiliated to Periyar University, it achieves 90%+ placement rates with
          ...
          <p className="text-base sm:text-lg text-white/80 max-w-2xl mx-auto mb-10 leading-relaxed">
            Rasipuram to JKKN — about 1 hour 15 minutes by road via
            Tiruchengode. At ~60 km, most Rasipuram students choose the campus
            hostel: furnished rooms, three meals a day, WiFi, and 24/7 security,
            with the library and labs a short walk away.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=cas.jkkn.ac.in&utm_medium=organic&utm_campaign=rasipuram"
              target="_blank"
      ...
      {/* Distance Card */}
      <section aria-label="Distance from Rasipuram" className="bg-[#FBFBEE] py-10 sm:py-12">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 flex flex-wrap sm:flex-nowrap items-center justify-between gap-4 p-6">
            <div className="flex items-center gap-4">
              <span className="text-5xl sm:text-6xl font-bold text-[#006837] leading-none">
                60<span className="text-2xl font-semibold text-[#006837]">km</span>
              </span>
              <div>
                <div className="font-bold text-gray-800 text-base sm:text-lg">
                  From Rasipuram to JKKN CAS
                </div>
                <div className="text-gray-500 text-sm mt-1">
                  ~1 hr 15 min by road — most Rasipuram students choose the campus hostel
                </div>
              </div>
            </div>
            <a
      ...
      {/* Why Rasipuram Students Choose JKKN CAS */}
      <section aria-label="Why choose JKKN" className="bg-white py-14 sm:py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
              Why Learners from Rasipuram Prefer JKKN CAS
            </h2>
            <p className="text-gray-500 max-w-2xl mx-auto text-sm sm:text-base leading-relaxed">
              Rasipuram — known for its silk sarees and as an education hub for
              the eastern side of Namakkal district — sends students across the
              district for quality degrees. JKKN CAS is in the same Namakkal
              district, approximately 60 km away, and its full residential
              campus with separate boys and girls hostels makes it a natural
              choice: stay on campus, study more, travel less.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              },
              {
                Icon: Home,
                title: "Hostel Life",
                desc: "~60 km from Rasipuram — separate boys and girls hostels with three meals, WiFi, and 24/7 security.",
              },
            ].map((item) => (
              <div
                key={item.title}
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              UG &amp; PG Programmes Near Rasipuram
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
            {[
              {
                Icon: FlaskConical,
                name: "B.Sc College Near Rasipuram — JKKN CAS",
                duration: "3 years",
                level: "UG",
                intake: "200+ seats",
              ...
              {
                Icon: BarChart2,
                name: "B.Com College Near Rasipuram — JKKN CAS",
                duration: "3 years",
                level: "UG",
                intake: "150 seats",
              ...
              {
                Icon: Briefcase,
                name: "BBA College Near Rasipuram — JKKN CAS",
                duration: "3 years",
                level: "UG",
                intake: "60 seats",
              ...
              {
                Icon: Monitor,
                name: "BCA College Near Rasipuram — JKKN CAS",
                duration: "3 years",
                level: "UG",
                intake: "60 seats",
          ...
          <div className="mt-12 pt-10 border-t border-gray-200">
            <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2 text-center">
              All 35 Programmes Available Near Rasipuram
            </h3>
      ...
      <section aria-label="Placement highlights" className="bg-white py-14 sm:py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              Where Rasipuram Graduates Are Working Now
            </h2>
            <p className="text-gray-500 text-sm sm:text-base">
              ...
              {[
                {
                  Icon: MapPin,
                  label: "ROUTE",
                  info: "Rasipuram → Tiruchengode → Komarapalayam road; campus on NH-544 at Natarajapuram",
                  bg: "bg-[#FBFBEE]",
                },
                {
                  Icon: Bus,
                  label: "BY BUS",
                  info: "Buses from Rasipuram via Tiruchengode to Komarapalayam; also Salem-side connections on NH-544",
                  bg: "bg-[#FBFBEE]",
                },
                {
                  Icon: Train,
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              },
              {
                Icon: Bus,
                title: "Transport",
                desc: "College buses connecting to nearby towns across the district",
                bg: "bg-[#FBFBEE]",
              },
              {
                Icon: Activity,
      ...
      <section className="bg-[#FBFBEE] py-14 sm:py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              Learners from Rasipuram Love JKKN CAS
            </h2>
            <p className="text-gray-500 text-sm sm:text-base">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100">
              ...
              <p className="text-gray-500 text-sm leading-relaxed italic">
                [Learner testimonial from Rasipuram to be added here. Include
                their experience at JKKN CAS, what they liked about hostel life
                on campus, and their career outcomes.]
              </p>
              <div className="mt-4">
                <div className="font-bold text-gray-800 text-sm">
                  [Learner Name]
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100">
              ...
              <p className="text-gray-500 text-sm leading-relaxed italic">
                [Second learner testimonial from Rasipuram to be added here.
                Focus on hostel life and the quality of education.]
              </p>
              <div className="mt-4">
                <div className="font-bold text-gray-800 text-sm">
                  [Learner Name]
            ...
            <div className="rounded-2xl p-6 border-2 border-dashed border-[#7cb983] bg-[#FBFBEE] flex items-center justify-center">
              <p className="text-[#006837] text-sm font-medium text-center leading-relaxed">
                Add 2-3 real learner testimonials from Rasipuram or nearby areas
                before deployment.
              </p>
            </div>
          </div>
      ...
      {/* Comparison Table */}
      <section aria-label="Comparison with Rasipuram-area colleges" className="bg-[#FBFBEE] py-14 sm:py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              JKKN CAS vs Local Rasipuram-Area Colleges
            </h2>
            <div className="mx-auto mt-4 w-12 h-1 bg-[#7cb983] rounded-full" />
          </div>
            ...
            <table className="w-full text-sm border-collapse bg-white">
              <thead>
                <tr className="bg-[#006837] text-white">
                  ...
                  <th className="p-3 text-left font-semibold">Typical local college</th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr className="border-b border-gray-100 bg-[#FBFBEE]">
                  <td className="p-3 text-gray-600">Distance from Rasipuram</td>
                  <td className="p-3 text-gray-800 font-medium">~60 km — hostel option</td>
                ...
                <tr className="border-b border-gray-100 bg-[#FBFBEE]">
                  ...
                  <td className="p-3 text-gray-800 font-medium">Full residential campus (boys + girls)</td>
      ...
      <section id="faq-section" aria-label="Frequently asked questions" className="bg-white py-14 sm:py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 text-sm sm:text-base">
              Arts and Science College near Rasipuram — Your Questions Answered
            </p>
            <div className="mx-auto mt-4 w-12 h-1 bg-[#7cb983] rounded-full" />
          </div>
