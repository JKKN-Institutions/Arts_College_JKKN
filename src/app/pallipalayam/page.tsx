...
export const metadata: Metadata = {
  ...
  keywords: [
    "arts and science college near pallipalayam",
    "colleges near pallipalayam",
    "best college near pallipalayam",
    "degree college near pallipalayam",
    "JKKN CAS Pallipalayam",
    "BCA college near Pallipalayam",
    "BBA college near Pallipalayam",
    "B.Com college near Pallipalayam",
    "affordable college near Pallipalayam",
  ],

  robots: "index, follow",

  alternates: {
    canonical: "https://cas.jkkn.ac.in/pallipalayam",
  },
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "JKKN College of Arts and Science — campus near Pallipalayam on NH-544",
      },
    ],
  },
...
export default function PallipalayamPage() {
  const faqs = [
    {
    ...
    },
    {
      ...
      a: "JKKN CAS is approximately 14 km from Pallipalayam, a journey of about 20–25 minutes by road along the Cauvery-side route to Komarapalayam. Both towns are in Namakkal district, so the commute stays short and simple. College transport is also available.",
    },
    {
    ...
    },
    {
      ...
      a: "Regular buses connect Pallipalayam with Komarapalayam along the Cauvery-side route, and all NH-544 corridor buses stop at Komarapalayam. The journey takes about 20–25 minutes. The JKKN campus sits directly on NH-544 at Natarajapuram, making it easy to reach from any Komarapalayam bus stop.",
    },
    {
      q: "Are JKKN CAS fees affordable for Pallipalayam students?",
    ...
    {
      q: "Does JKKN CAS provide hostel for Pallipalayam students?",
      a: "JKKN CAS provides separate hostel accommodation for boys and girls on the main campus. The hostel includes furnished rooms, three meals per day, WiFi, and 24/7 security. Learners from Pallipalayam can also commute daily as the campus is just about 20–25 minutes away by road.",
    },
    {
  ...
  const schemaFaqs = [
    {
      ...
      answer:
        "JKKN College of Arts and Science, located approximately 14 km from Pallipalayam at Komarapalayam on NH-544, is a NAAC-accredited institution with 35 programmes and 90%+ placement rates. It is affiliated to Periyar University and approved by UGC.",
    },
    {
      question: "How far is JKKN CAS from Pallipalayam?",
      answer:
        "JKKN CAS is approximately 14 km from Pallipalayam, a journey of about 20 to 25 minutes by road along the Cauvery-side route to Komarapalayam. Both towns are in Namakkal district, so the commute stays short and simple.",
    },
    {
      question: "Is there a direct bus from Pallipalayam to JKKN CAS?",
      answer:
        "Regular buses connect Pallipalayam with Komarapalayam along the Cauvery-side route, and all NH-544 corridor buses stop at Komarapalayam. The journey takes about 20 to 25 minutes. The JKKN campus sits directly on NH-544 at Natarajapuram.",
    },
    {
      question: "Does JKKN CAS offer hostel facilities for students from Pallipalayam?",
      answer:
        "JKKN CAS provides separate hostel accommodation for boys and girls on the main campus. The hostel includes furnished rooms, three meals per day, WiFi, and 24/7 security. Pallipalayam students can also commute daily as the campus is about 20 to 25 minutes away.",
    },
    {
      question: "Are fees at JKKN CAS affordable for Pallipalayam students?",
      answer:
    ...
    {
      question: "Which courses are available at colleges near Pallipalayam?",
      answer:
        "JKKN CAS near Pallipalayam offers BCA, BBA, B.Com, B.Sc across 8 specialisations, MCA, M.Com, M.Sc, and Ph.D programmes — 35 courses in total. All programmes are UGC-approved and affiliated to Periyar University.",
    },
    {
  ...
  return (
    <main>
      <BreadcrumbSchema items={[
        ...
        { name: "Pallipalayam", url: "https://cas.jkkn.ac.in/pallipalayam" },
      ]} />
          ...
          __html: JSON.stringify({
            ...
            "breadcrumb": {
              ...
              "itemListElement": [
                ...
                { "@type": "ListItem", "position": 2, "name": "Pallipalayam", "item": "https://cas.jkkn.ac.in/pallipalayam" }
              ]
            },
            "speakable": {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "url": "https://cas.jkkn.ac.in",
            "foundingDate": "1974",
            "description": "JKKN College of Arts and Science is a NAAC-accredited institution on NH-544 approximately 14 km from Pallipalayam, offering 34 UG, PG, and Ph.D programmes in arts, science, commerce, and computer applications, affiliated to Periyar University.",
      ...
      <CourseSchema
        ...
        description="3-year undergraduate science programme with specialisations in Chemistry, Mathematics, Zoology, Physics, Microbiology, Computer Science, and more at JKKN CAS near Pallipalayam."
        duration="PT3Y"
        educationalLevel="UG"
        category="Aided"
      ...
      <CourseSchema
        ...
        description="3-year undergraduate commerce programme with strong industry exposure and placement support at JKKN CAS, approximately 14 km from Pallipalayam."
        duration="PT3Y"
        educationalLevel="UG"
        category="Aided"
      ...
      <CourseSchema
        ...
        description="3-year undergraduate management programme building future business leaders, offered at JKKN CAS — approximately 14 km from Pallipalayam."
        duration="PT3Y"
        educationalLevel="UG"
      ...
      <section aria-label="Hero" className="relative bg-gradient-to-br from-[#002309] via-[#006837] to-[#002309] text-white overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-20 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight mb-4">
            Arts and Science College near Pallipalayam — JKKN CAS
          </h1>

          {/* Featured Snippet Paragraph */}
          <h2 className="text-xl font-semibold text-white mb-3">
            Best College near Pallipalayam — JKKN CAS
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=cas.jkkn.ac.in&utm_medium=organic&utm_campaign=pallipalayam"
              target="_blank"
      ...
      {/* Distance Card */}
      <section aria-label="Distance from Pallipalayam" className="bg-[#FBFBEE] py-10 sm:py-12">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 flex flex-wrap sm:flex-nowrap items-center justify-between gap-4 p-6">
            <div className="flex items-center gap-4">
              <span className="text-5xl sm:text-6xl font-bold text-[#006837] leading-none">
                14<span className="text-2xl font-semibold text-[#006837]">km</span>
              </span>
              <div>
                <div className="font-bold text-gray-800 text-base sm:text-lg">
                  From Pallipalayam to JKKN CAS
                </div>
                <div className="text-gray-500 text-sm mt-1">
                  ~20-25 minutes by road along the Cauvery — both towns in Namakkal district
                </div>
              </div>
            </div>
            <a
      ...
      {/* Why Pallipalayam Students Choose JKKN CAS */}
      <section aria-label="Why choose JKKN" className="bg-white py-14 sm:py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
              Why Learners from Pallipalayam Prefer JKKN CAS
            </h2>
            <p className="text-gray-500 max-w-2xl mx-auto text-sm sm:text-base leading-relaxed">
              Pallipalayam&apos;s strong paper and textile industrial base means
              families value quality education with good placement outcomes.
              JKKN is approximately 14 km away along the Cauvery-side route to
              Komarapalayam — no need to cross into Erode city traffic. Both
              towns are in Namakkal district, making the daily commute
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              },
              {
                Icon: Bus,
                title: "Easy Commute",
                desc: "Just ~14 km from Pallipalayam. Daily commute or comfortable hostel — your choice.",
              },
            ].map((item) => (
              <div
                key={item.title}
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              Degree College near Pallipalayam — UG &amp; PG Programmes
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
            {[
              {
                Icon: FlaskConical,
                name: "B.Sc College Near Pallipalayam — JKKN CAS",
                duration: "3 years",
                level: "UG",
                intake: "200+ seats",
              ...
              {
                Icon: BarChart2,
                name: "B.Com College Near Pallipalayam — JKKN CAS",
                duration: "3 years",
                level: "UG",
                intake: "150 seats",
              ...
              {
                Icon: Briefcase,
                name: "BBA College Near Pallipalayam — JKKN CAS",
                duration: "3 years",
                level: "UG",
                intake: "60 seats",
              ...
              {
                Icon: Monitor,
                name: "BCA College Near Pallipalayam — JKKN CAS",
                duration: "3 years",
                level: "UG",
                intake: "60 seats",
          ...
          <div className="mt-12 pt-10 border-t border-gray-200">
            <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2 text-center">
              All 35 Programmes Available Near Pallipalayam
            </h3>
      ...
      <section aria-label="Placement highlights" className="bg-white py-14 sm:py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              Where Pallipalayam Graduates Are Working Now
            </h2>
            <p className="text-gray-500 text-sm sm:text-base">
      ...
      {/* How to Reach from Pallipalayam */}
              ...
              {[
                {
                  Icon: MapPin,
                  label: "ROUTE",
                  info: "Pallipalayam → Komarapalayam along the Cauvery-side road; campus on NH-544 at Natarajapuram",
                  bg: "bg-[#FBFBEE]",
                },
                {
                  Icon: Bus,
                  label: "BY BUS",
                  info: "Regular buses between Pallipalayam and Komarapalayam; all NH-544 corridor buses stop at Komarapalayam",
                  bg: "bg-[#FBFBEE]",
                },
                {
                  Icon: Train,
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              },
              {
                Icon: Bus,
                title: "Transport",
                desc: "College buses connecting to Pallipalayam, Erode, and surrounding areas",
                bg: "bg-[#FBFBEE]",
              },
              {
                Icon: Activity,
      ...
      <section className="bg-[#FBFBEE] py-14 sm:py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              Learners from Pallipalayam Love JKKN CAS
            </h2>
            <p className="text-gray-500 text-sm sm:text-base">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100">
              ...
              <p className="text-gray-500 text-sm leading-relaxed italic">
                [Learner testimonial from Pallipalayam to be added here. Include
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100">
              ...
              <p className="text-gray-500 text-sm leading-relaxed italic">
                [Second learner testimonial from Pallipalayam to be added here.
            ...
            <div className="rounded-2xl p-6 border-2 border-dashed border-[#7cb983] bg-[#FBFBEE] flex items-center justify-center">
              <p className="text-[#006837] text-sm font-medium text-center leading-relaxed">
                Add 2-3 real learner testimonials from Pallipalayam or nearby
      ...
      <section aria-label="Comparison with Erode city colleges" className="bg-[#FBFBEE] py-14 sm:py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              JKKN CAS vs Erode City Colleges — For Pallipalayam Students
            </h2>
            <div className="mx-auto mt-4 w-12 h-1 bg-[#7cb983] rounded-full" />
          </div>
            ...
            <table className="w-full text-sm border-collapse bg-white">
              ...
              <tbody>
                ...
                <tr className="border-b border-gray-100 bg-[#FBFBEE]">
                  <td className="p-3 text-gray-600">Distance from Pallipalayam</td>
                  <td className="p-3 text-gray-800 font-medium">~14 km to JKKN</td>
                  <td className="p-3 text-gray-500">Crossing into Erode city traffic</td>
                </tr>
                <tr className="border-b border-gray-100">
      ...
      <section id="faq-section" aria-label="Frequently asked questions" className="bg-white py-14 sm:py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 text-sm sm:text-base">
              Colleges near Pallipalayam — Your Questions Answered
            </p>
            <div className="mx-auto mt-4 w-12 h-1 bg-[#7cb983] rounded-full" />
          </div>
