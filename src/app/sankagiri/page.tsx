...
export const metadata: Metadata = {
  ...
  description:
    "JKKN CAS — NAAC-accredited arts and science college ~15-20 km from Sankagiri on NH-544. 35 programmes, NIRF-published placement outcomes. Admissions open 2026–27.",
  ...
  openGraph: {
    title: "Arts and Science College near Sankagiri — JKKN CAS",
    description:
      "JKKN CAS — NAAC-accredited, 35 programmes, NIRF-published placement outcomes. ~15-20 km from Sankagiri via NH-544. Admissions open 2026–27.",
  ...
  twitter: {
    ...
    title: "Arts and Science College near Sankagiri — JKKN CAS",
    description:
      "NAAC-accredited arts college near Sankagiri. 35 programmes, NIRF-published placement outcomes, hostel available. Admissions 2026–27 open.",
  },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "url": "https://cas.jkkn.ac.in/sankagiri",
            "description": "JKKN College of Arts and Science — NAAC-accredited arts and science college accessible from Sankagiri via the NH-544 corridor (~15-20 km). 35 programmes, NIRF-published placement outcomes, hostel available.",
            "isPartOf": {
              "@type": "WebSite",
      ...
      <section aria-label="Hero" className="relative bg-gradient-to-br from-[#002309] via-[#006837] to-[#002309] text-white overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-20 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=cas.jkkn.ac.in&utm_medium=organic&utm_campaign=sankagiri"
              target="_blank"
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="mt-12 pt-10 border-t border-gray-200">
            <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2 text-center">
              All 35 Programmes Available Near Sankagiri
            </h3>
