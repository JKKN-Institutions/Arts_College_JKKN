      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 md:py-16 lg:py-20">
        ...
        <div className="mb-8">
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-brand-green mb-2">
            JKKN College of Arts and Science — About Our Institution
          </h1>
        ...
        <div className="space-y-6 text-gray-800">
          ...
          <p className="text-sm md:text-base leading-relaxed">
            Our senior learners have organized, participated and presented papers in various Seminars, Conferences, Symposiums and Workshops. Many of our team members have attended Faculty Development Programme to enrich themselves.
          </p>

          <p className="text-sm md:text-base leading-relaxed">
            In order to instil cultural and traditional values in our learners, Pongal festival is celebrated in the College premises with a competitive spirit among the sister concerns and many times we have won prizes.
          </p>

          <p className="text-sm md:text-base leading-relaxed">
            The holistic value based education imparted in our College has helped in producing competent learners output. We have created Gazetted Officers, successful entrepreneurs and bureaucrats, private and public sector employees and bright academicians as our alumni.
          </p>
        </div>
      </div>
    </div>
