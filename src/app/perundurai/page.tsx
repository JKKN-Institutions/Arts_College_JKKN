...
export const metadata: Metadata = {
  title: "Arts and Science College near Perundurai | JKKN CAS",
  // 52 chars — within 60 limit

  description:
    "JKKN CAS — NAAC-accredited arts and science college ~27-30 km from Perundurai. 34 programmes, 80%+ placements. Admissions open 2026–27.",
  // ~136 chars — within 155 limit

  keywords: [
    "arts and science college near perundurai",
    "colleges near perundurai",
    "best college near perundurai",
    "degree college near perundurai",
    "JKKN CAS Perundurai",
    "BCA college near Perundurai",
    "BBA college near Perundurai",
    "B.Com college near Perundurai",
    "affordable college near Perundurai",
  ],

  robots: "index, follow",

  alternates: {
    canonical: "https://cas.jkkn.ac.in/perundurai",
  },

  openGraph: {
    title: "Arts and Science College near Perundurai — JKKN CAS",
    description:
      "JKKN CAS — NAAC-accredited, 34 programmes, 80%+ placements. ~27-30 km from Perundurai. Admissions open 2026–27.",
    url: "https://cas.jkkn.ac.in/perundurai",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "JKKN College of Arts and Science — campus near Perundurai on NH-544",
      },
    ],
  },
  ...
  twitter: {
    ...
    title: "Arts and Science College near Perundurai — JKKN CAS",
    description:
      "NAAC-accredited arts college near Perundurai. 34 programmes, 80%+ placements, hostel available. Admissions 2026–27 open.",
  },
};
...
export default function PerunduraiPage() {
  const faqs = [
    ...
    },
    {
      ...
      a: "JKKN CAS is approximately 27-30 km from Perundurai, a journey of about 35-40 minutes by road via the Erode/Chithode side. Direct buses run between Perundurai and Komarapalayam, and the Erode corridor offers frequent connections throughout the day. The campus sits directly on NH-544 at Natarajapuram.",
    },
    {
    ...
    },
    {
      ...
      a: "Direct buses run between Perundurai and Komarapalayam, and the journey takes about 35-40 minutes. Frequent buses on the Erode corridor also connect Perundurai to Komarapalayam with a short hop. The JKKN campus sits directly on NH-544, making it accessible from any bus stop at the highway.",
    },
    {
    ...
    },
    {
      ...
      a: "JKKN CAS provides separate hostel accommodation for boys and girls on the main campus. The hostel includes furnished rooms, three meals per day, WiFi, and 24/7 security. Learners from Perundurai can also commute daily as the campus is about 35-40 minutes away, with direct buses available.",
    },
    {
    ...
    },
    {
      ...
      a: "Perundurai's SIPCOT industrial belt means families value education with strong placement outcomes. JKKN CAS offers lower fees, NAAC accreditation, a residential campus, and 80%+ placements with national recruiters. The ~27-30 km route via the Erode/Chithode side makes daily commute viable, and hostel facilities are available for those who prefer on-campus living.",
    },
  ];
  ...
  const schemaFaqs = [
    {
      ...
      answer:
        "JKKN College of Arts and Science, located approximately 27-30 km from Perundurai on NH-544 at Komarapalayam, is a NAAC-accredited institution with 34 programmes and 80%+ placement rates. It is affiliated to Periyar University and Bharathiar University and approved by UGC.",
    },
    {
      question: "How far is JKKN CAS from Perundurai?",
      answer:
        "JKKN CAS is approximately 27-30 km from Perundurai, a journey of about 35 to 40 minutes by road via the Erode/Chithode side. Direct buses run between Perundurai and Komarapalayam, and the campus sits directly on NH-544.",
    },
    {
      question: "Is there a direct bus from Perundurai to JKKN CAS?",
      answer:
        "Direct buses run between Perundurai and Komarapalayam, taking about 35 to 40 minutes. Frequent buses on the Erode corridor also connect the two towns. The JKKN campus sits directly on NH-544 at Natarajapuram, Komarapalayam.",
    },
    {
      question: "Does JKKN CAS offer hostel facilities for students from Perundurai?",
      answer:
        "JKKN CAS provides separate hostel accommodation for boys and girls on the main campus. The hostel includes furnished rooms, three meals per day, WiFi, and 24/7 security. Perundurai students can also commute daily by direct bus.",
    },
    {
      question: "Are fees at JKKN CAS affordable for Perundurai students?",
      answer:
        "JKKN CAS fees are lower than most private colleges in the Erode region. Tamil Nadu government scholarships for BC, MBC, SC, and ST students are available. Contact the admission office at +91 9345855001 for the current fee structure.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "JKKN CAS offers lower fees, NAAC accreditation, a residential campus, and 80%+ placements with national recruiters. The ~27-30 km route via the Erode/Chithode side makes daily commute viable, and hostel facilities are available.",
    },
  ];
  ...
  return (
    <main>
      <BreadcrumbSchema items={[
        ...
        { name: "Perundurai", url: "https://cas.jkkn.ac.in/perundurai" },
      ]} />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebPage",
            "name": "Arts and Science College near Perundurai — JKKN CAS",
            "url": "https://cas.jkkn.ac.in/perundurai",
            "description": "JKKN College of Arts and Science — NAAC-accredited arts and science college approximately 27-30 km from Perundurai via the Erode/Chithode side. 34 programmes, 80%+ placements, hostel available.",
            "isPartOf": {
              "@type": "WebSite",
            ...
            "breadcrumb": {
              ...
              "itemListElement": [
                ...
                { "@type": "ListItem", "position": 2, "name": "Perundurai", "item": "https://cas.jkkn.ac.in/perundurai" }
              ]
            },
            "speakable": {
      ...
      <CourseSchema
        ...
        description="3-year undergraduate science programme with specialisations in Chemistry, Mathematics, Zoology, Physics, Microbiology, Computer Science, and more at JKKN CAS near Perundurai."
        duration="PT3Y"
        educationalLevel="UG"
        category="Aided"
      ...
      <CourseSchema
        ...
        description="3-year undergraduate commerce programme with strong industry exposure and placement support at JKKN CAS, accessible from Perundurai via the Erode/Chithode side."
        duration="PT3Y"
        educationalLevel="UG"
        category="Aided"
      ...
      <CourseSchema
        ...
        description="3-year undergraduate management programme building future business leaders, offered at JKKN CAS — approximately 27-30 km from Perundurai."
        duration="PT3Y"
        educationalLevel="UG"
      ...
      <CourseSchema
        ...
        description="3-year undergraduate IT programme with hands-on training and 80%+ placement rate at JKKN CAS, easily reachable from Perundurai."
        duration="PT3Y"
        educationalLevel="UG"
        category="Self-Finance"
      ...
      <section aria-label="Hero" className="relative bg-gradient-to-br from-[#002309] via-[#006837] to-[#002309] text-white overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-20 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight mb-4">
            Arts and Science College near Perundurai — JKKN CAS
          </h1>

          {/* Featured Snippet Paragraph */}
          <h2 className="text-xl font-semibold text-white mb-3">
            Best College near Perundurai — JKKN CAS
          </h2>
          ...
          <p className="text-base sm:text-lg text-white/80 max-w-2xl mx-auto mb-10 leading-relaxed">
            Perundurai to JKKN — about 35-40 minutes by road via the
            Erode/Chithode side. JKKN College of Arts and Science offers
            NAAC-accredited arts and science programmes with 80%+ placement
            support — approximately 27-30 km from Perundurai with direct bus
            connectivity.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=cas.jkkn.ac.in&utm_medium=organic&utm_campaign=perundurai"
              target="_blank"
      ...
      {/* Distance Card */}
      <section aria-label="Distance from Perundurai" className="bg-[#FBFBEE] py-10 sm:py-12">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 flex flex-wrap sm:flex-nowrap items-center justify-between gap-4 p-6">
            <div className="flex items-center gap-4">
              <span className="text-5xl sm:text-6xl font-bold text-[#006837] leading-none">
                28<span className="text-2xl font-semibold text-[#006837]">km</span>
              </span>
              <div>
                <div className="font-bold text-gray-800 text-base sm:text-lg">
                  From Perundurai to JKKN CAS
                </div>
                <div className="text-gray-500 text-sm mt-1">
                  ~27-30 km, 35-40 minutes — direct buses available
                </div>
              </div>
            </div>
            <a
      ...
      {/* Why Perundurai Students Choose JKKN CAS */}
      <section aria-label="Why choose JKKN" className="bg-white py-14 sm:py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
              Why Learners from Perundurai Prefer JKKN CAS
            </h2>
            <p className="text-gray-500 max-w-2xl mx-auto text-sm sm:text-base leading-relaxed">
              Perundurai, in Erode district, is known for its SIPCOT industrial
              estate and a growing education belt — families here value quality
              education with good placement outcomes. JKKN is approximately
              27-30 km away via the Erode/Chithode side, with direct buses
              making the daily commute comfortable and quick.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              },
              {
                Icon: Bus,
                title: "Easy Commute",
                desc: "~27-30 km from Perundurai. Daily commute by direct bus or comfortable hostel — your choice.",
              },
            ].map((item) => (
              <div
                key={item.title}
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              UG &amp; PG Programmes — Degree College Near Perundurai
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
            {[
              {
                Icon: FlaskConical,
                name: "B.Sc College Near Perundurai — JKKN CAS",
                duration: "3 years",
                level: "UG",
                intake: "200+ seats",
              ...
              {
                Icon: BarChart2,
                name: "B.Com College Near Perundurai — JKKN CAS",
                duration: "3 years",
                level: "UG",
                intake: "150 seats",
              ...
              {
                Icon: Briefcase,
                name: "BBA College Near Perundurai — JKKN CAS",
                duration: "3 years",
                level: "UG",
                intake: "60 seats",
              ...
              {
                Icon: Monitor,
                name: "BCA College Near Perundurai — JKKN CAS",
                duration: "3 years",
                level: "UG",
                intake: "60 seats",
      ...
      <section aria-label="Placement highlights" className="bg-white py-14 sm:py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              Where Perundurai Graduates Are Working Now
            </h2>
            <p className="text-gray-500 text-sm sm:text-base">
            ...
            <div className="bg-[#006837] text-white px-6 py-4 flex items-center gap-3">
              ...
              <div>
                <div className="font-bold text-base">
                  Perundurai → JKKN CAS Campus
                </div>
                <div className="text-[#7cb983] text-sm">
                  ~27-30 km • 35-40 minutes
                </div>
              </div>
            </div>
              ...
              {[
                {
                  Icon: MapPin,
                  label: "ROUTE",
                  info: "Perundurai → Chithode/Erode side → Komarapalayam; campus on NH-544 at Natarajapuram",
                  bg: "bg-[#FBFBEE]",
                },
                {
                  Icon: Bus,
                  label: "BY BUS",
                  info: "Direct buses between Perundurai and Komarapalayam; frequent Erode-corridor connections",
                  bg: "bg-[#FBFBEE]",
                },
                {
                  Icon: Train,
      ...
      <section className="bg-[#FBFBEE] py-14 sm:py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              Learners from Perundurai Love JKKN CAS
            </h2>
            <p className="text-gray-500 text-sm sm:text-base">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100">
              ...
              <p className="text-gray-500 text-sm leading-relaxed italic">
                [Learner testimonial from Perundurai to be added here. Include
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100">
              ...
              <p className="text-gray-500 text-sm leading-relaxed italic">
                [Second learner testimonial from Perundurai to be added here.
            ...
            <div className="rounded-2xl p-6 border-2 border-dashed border-[#7cb983] bg-[#FBFBEE] flex items-center justify-center">
              <p className="text-[#006837] text-sm font-medium text-center leading-relaxed">
                Add 2-3 real learner testimonials from Perundurai or nearby
      ...
      <section aria-label="Comparison with Erode city colleges" className="bg-[#FBFBEE] py-14 sm:py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              JKKN CAS vs Erode City Colleges — For Perundurai Students
            </h2>
            <div className="mx-auto mt-4 w-12 h-1 bg-[#7cb983] rounded-full" />
          </div>
            ...
            <table className="w-full text-sm border-collapse bg-white">
              ...
              <tbody>
                ...
                <tr className="border-b border-gray-100 bg-[#FBFBEE]">
                  <td className="p-3 text-gray-600">Distance from Perundurai</td>
                  <td className="p-3 text-gray-800 font-medium">~27-30 km via Erode/Chithode</td>
      ...
      <section id="faq-section" aria-label="Frequently asked questions" className="bg-white py-14 sm:py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 text-sm sm:text-base">
              Arts and Science College near Perundurai — Your Questions Answered
            </p>
            <div className="mx-auto mt-4 w-12 h-1 bg-[#7cb983] rounded-full" />
          </div>
