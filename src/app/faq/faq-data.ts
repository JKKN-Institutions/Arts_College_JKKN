/**
 * The ONE copy of the /faq questions.
 *
 * Until 2026-09-18 this list lived inside FaqClient.tsx while faq/page.tsx
 * published a second, hand-maintained `schemaFaqs` array to JSON-LD. The two
 * drifted: 3 of the 8 answers in the schema appeared nowhere on the page. A
 * server component cannot import a value out of a "use client" module, so the
 * data lives here and both sides read it.
 */
...
/** Flat list, for the FAQPage JSON-LD. Schema count === rendered count. */
export const allFaqs: FaqEntry[] = faqCategories.flatMap((c) => c.faqs);
