...
export default function KomarapalayamPage() {
  const faqs = [
    ...
    },
    {
      ...
      a: "Yes. JKKN College of Arts and Science is located in Komarapalayam town itself, at Natarajapuram on NH-544 (Namakkal District, Tamil Nadu 638183). The campus sits directly on the Salem–Erode highway stretch, a walkable or short ride from the Komarapalayam bus stop. It is a NAAC-accredited institution established in 1974.",
    },
    {
    ...
    },
    {
      ...
      a: "JKKN College of Arts and Science is NAAC-accredited and UGC-approved. The college is affiliated to Periyar University. It is part of the JKKN Group of Institutions in Komarapalayam, which includes 7 colleges, 2 schools, and a 500-bed teaching hospital.",
    },
    {
  ...
  const schemaFaqs = [
    ...
    },
    {
      ...
      answer:
        "JKKN CAS in Komarapalayam offers 35 programmes: BCA, BBA, B.Com, B.A., and B.Sc across 8 specialisations at UG level, plus MCA, M.Com, M.Sc, and Ph.D programmes. All are UGC-approved and affiliated to Periyar University.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "JKKN College of Arts and Science is NAAC-accredited and UGC-approved. The college is affiliated to Periyar University. It is part of the JKKN Group of Institutions in Komarapalayam.",
    },
    {
      ...
      <section aria-label="Hero" className="relative bg-gradient-to-br from-[#002309] via-[#006837] to-[#002309] text-white overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-20 text-center">
          ...
          <p className="snippet-answer-paragraph text-base sm:text-lg text-white/80 max-w-2xl mx-auto mb-6 leading-relaxed">
            ...
            Periyar University, it achieves 90%+
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="mt-12 pt-10 border-t border-gray-200">
            <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2 text-center">
              All 35 Programmes Available in Komarapalayam
            </h3>
