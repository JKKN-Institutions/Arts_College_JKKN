...
export const metadata: Metadata = {
  title: "Arts and Science College near Gobichettipalayam | JKKN",
  // 55 chars — within 60 limit

  description:
    "JKKN CAS — NAAC-accredited college near Gobichettipalayam, ~35-40 km via Bhavani. 34 programmes, 80%+ placements. Admissions open 2026–27.",
  // ~138 chars — within 155 limit

  keywords: [
    "arts and science college in gobichettipalayam",
    "colleges in gobichettipalayam",
    "colleges near gobi",
    "best college near gobichettipalayam",
    "arts and science college near gobi",
    "JKKN CAS Gobichettipalayam",
    "BCA college near Gobichettipalayam",
    "BBA college near Gobichettipalayam",
    "B.Com college near Gobi",
    "affordable college near Gobichettipalayam",
  ],

  robots: "index, follow",

  alternates: {
    canonical: "https://cas.jkkn.ac.in/gobichettipalayam",
  },

  openGraph: {
    title: "Arts and Science College near Gobichettipalayam — JKKN CAS",
    description:
      "JKKN CAS — NAAC-accredited, 34 programmes, 80%+ placements. ~35-40 km from Gobichettipalayam via Bhavani. Admissions open 2026–27.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "JKKN College of Arts and Science — campus near Gobichettipalayam on NH-544",
      },
    ],
  },
  ...
  twitter: {
    ...
    title: "Arts and Science College near Gobichettipalayam — JKKN CAS",
    description:
      "NAAC-accredited arts college near Gobichettipalayam. 34 programmes, 80%+ placements, hostel available. Admissions 2026–27 open.",
  },
};
...
export default function GobichettipalayamPage() {
  const faqs = [
    ...
    },
    {
      ...
      a: "JKKN CAS is approximately 35-40 km from Gobichettipalayam, a journey of about 1 hour by road via Bhavani. Buses from Gobi run through Bhavani to Komarapalayam, and the campus sits directly on NH-544 at Natarajapuram. College transport is also available for day scholars.",
    },
    {
      q: "Is there a bus from Gobichettipalayam to JKKN CAS via Bhavani?",
      a: "Buses from Gobichettipalayam run via Bhavani and reach Komarapalayam, where the JKKN campus sits directly on NH-544 at Natarajapuram. At this ~35-40 km distance, both options work well — daily commute with college transport or staying in the campus hostel.",
    },
    {
    ...
    },
    {
      ...
      a: "JKKN CAS fees are lower than most private colleges in the region. Tamil Nadu government scholarships for BC, MBC, SC, and ST students are available. Merit-based concessions are also offered. Contact the admission office at +91 9345855001 for the current fee structure.",
    },
    {
      q: "Does JKKN CAS provide hostel for Gobichettipalayam students?",
      a: "JKKN CAS provides separate hostel accommodation for boys and girls on the main campus. The hostel includes furnished rooms, three meals per day, WiFi, and 24/7 security. Students from Gobichettipalayam can also commute daily via Bhavani with college transport, as the campus is about 1 hour away.",
    },
    {
  ...
  const schemaFaqs = [
    {
      ...
      answer:
        "JKKN College of Arts and Science, located approximately 35-40 km from Gobichettipalayam via Bhavani, is a NAAC-accredited institution with 34 programmes and 80%+ placement rates. It is affiliated to Periyar University and Bharathiar University and approved by UGC.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "JKKN CAS provides separate hostel accommodation for boys and girls on the main campus. The hostel includes furnished rooms, three meals per day, WiFi, and 24/7 security. Students from Gobichettipalayam can also commute daily via Bhavani with college transport.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "JKKN CAS achieves an 80%+ placement rate for graduating students. Recruiters include TCS, Infosys BPO, HDFC Bank, ICICI Bank, Amazon, Flipkart, and Jio. The highest package recorded is 5–7 LPA, with a 2–3.5 LPA average.",
    },
    {
      question: "How can students from Gobichettipalayam apply to JKKN CAS?",
      answer:
        "Applications for JKKN CAS are submitted online at admission.jkkn.ac.in or in person at the campus admission office. Admissions for 2026–27 are currently open. Call +91 9345855001 for guidance on the application process.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "JKKN CAS offers lower fees, NAAC accreditation, a residential campus, and 80%+ placements with national recruiters — advantages not uniformly available at colleges in the Gobi area. The ~35-40 km route via Bhavani makes daily commute viable.",
    },
  ];
  ...
  return (
    <main>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "url": "https://cas.jkkn.ac.in/gobichettipalayam",
            "description": "JKKN College of Arts and Science — NAAC-accredited arts and science college accessible from Gobichettipalayam via Bhavani, approximately 35-40 km away. 34 programmes, 80%+ placements, hostel available.",
            "isPartOf": {
              "@type": "WebSite",
            ...
            "breadcrumb": {
              ...
              "itemListElement": [
                ...
                { "@type": "ListItem", "position": 2, "name": "Gobichettipalayam", "item": "https://cas.jkkn.ac.in/gobichettipalayam" }
              ]
            },
            "speakable": {
      ...
      <CourseSchema
        ...
        description="3-year undergraduate science programme with specialisations in Chemistry, Mathematics, Zoology, Physics, Microbiology, Computer Science, and more at JKKN CAS near Gobichettipalayam."
        duration="PT3Y"
        educationalLevel="UG"
        category="Aided"
      ...
      <CourseSchema
        ...
        description="3-year undergraduate commerce programme with strong industry exposure and placement support at JKKN CAS, accessible from Gobichettipalayam via Bhavani."
        duration="PT3Y"
        educationalLevel="UG"
        category="Aided"
      ...
      <CourseSchema
        ...
        description="3-year undergraduate management programme building future business leaders, offered at JKKN CAS — approximately 35-40 km from Gobichettipalayam."
        duration="PT3Y"
        educationalLevel="UG"
      ...
      <CourseSchema
        ...
        description="3-year undergraduate IT programme with hands-on training and 80%+ placement rate at JKKN CAS, easily reachable from Gobichettipalayam via Bhavani."
        duration="PT3Y"
        educationalLevel="UG"
        category="Self-Finance"
      ...
      <section aria-label="Hero" className="relative bg-gradient-to-br from-[#002309] via-[#006837] to-[#002309] text-white overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-20 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight mb-4">
            Arts and Science College near Gobichettipalayam — JKKN CAS
          </h1>

          {/* Featured Snippet Paragraph */}
          <h2 className="text-xl font-semibold text-white mb-3">
            Best College near Gobichettipalayam — JKKN CAS
          </h2>
          ...
          <p className="text-base sm:text-lg text-white/80 max-w-2xl mx-auto mb-10 leading-relaxed">
            ...
            with 80%+ placement support — approximately 35-40 km from
      ...
      {/* Distance Card */}
      <section aria-label="Distance from Gobichettipalayam" className="bg-[#FBFBEE] py-10 sm:py-12">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 flex flex-wrap sm:flex-nowrap items-center justify-between gap-4 p-6">
            <div className="flex items-center gap-4">
              <span className="text-5xl sm:text-6xl font-bold text-[#006837] leading-none">
                38<span className="text-2xl font-semibold text-[#006837]">km</span>
              </span>
              <div>
                <div className="font-bold text-gray-800 text-base sm:text-lg">
                  From Gobichettipalayam to JKKN CAS
                </div>
                <div className="text-gray-500 text-sm mt-1">
                  ~35-40 km, about 1 hour via Bhavani
                </div>
              </div>
            </div>
            <a
      ...
      {/* Why Gobichettipalayam Students Choose JKKN CAS */}
      <section aria-label="Why choose JKKN" className="bg-white py-14 sm:py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
              Why Students from Gobichettipalayam Prefer JKKN CAS
            </h2>
            <p className="text-gray-500 max-w-2xl mx-auto text-sm sm:text-base leading-relaxed">
              Gobichettipalayam — locally called Gobi — is an agricultural and
              film-shooting town in Erode district where families value quality
              education with good placement outcomes. JKKN is approximately
              35-40 km away via Bhavani, about 1 hour by road, making both
              daily commute with college transport and hostel stay practical
              choices.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              },
              {
                Icon: Bus,
                title: "Easy Commute",
                desc: "~35-40 km from Gobi via Bhavani. Daily commute with college transport or comfortable hostel — your choice.",
              },
            ].map((item) => (
              <div
                key={item.title}
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              UG &amp; PG Programmes Near Gobichettipalayam
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
            {[
              {
                Icon: FlaskConical,
                name: "B.Sc College Near Gobichettipalayam — JKKN CAS",
                duration: "3 years",
                level: "UG",
                intake: "200+ seats",
              ...
              {
                Icon: BarChart2,
                name: "B.Com College Near Gobichettipalayam — JKKN CAS",
                duration: "3 years",
                level: "UG",
                intake: "150 seats",
              ...
              {
                Icon: Briefcase,
                name: "BBA College Near Gobichettipalayam — JKKN CAS",
                duration: "3 years",
                level: "UG",
                intake: "60 seats",
              ...
              {
                Icon: Monitor,
                name: "BCA College Near Gobichettipalayam — JKKN CAS",
                duration: "3 years",
                level: "UG",
                intake: "60 seats",
      ...
      <section aria-label="Placement highlights" className="bg-white py-14 sm:py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              Where Gobichettipalayam Graduates Are Working Now
            </h2>
            <p className="text-gray-500 text-sm sm:text-base">
      ...
      {/* How to Reach from Gobichettipalayam */}
            ...
            <div className="bg-[#006837] text-white px-6 py-4 flex items-center gap-3">
              ...
              <div>
                <div className="font-bold text-base">
                  Gobichettipalayam → JKKN CAS Campus
                </div>
              ...
              {[
                {
                  Icon: MapPin,
                  label: "ROUTE",
                  info: "Gobichettipalayam → Bhavani → Komarapalayam; campus on NH-544 at Natarajapuram",
                  bg: "bg-[#FBFBEE]",
                },
                {
                  Icon: Bus,
                  label: "BY BUS",
                  info: "Buses from Gobi via Bhavani to Komarapalayam; hostel and college transport options available",
                  bg: "bg-[#FBFBEE]",
                },
                {
                  Icon: Train,
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              },
              {
                Icon: Bus,
                title: "Transport",
                desc: "College buses connecting to Gobichettipalayam, Bhavani, and surrounding areas",
                bg: "bg-[#FBFBEE]",
              },
              {
                Icon: Activity,
      ...
      <section className="bg-[#FBFBEE] py-14 sm:py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              Students from Gobichettipalayam Love JKKN CAS
            </h2>
            <p className="text-gray-500 text-sm sm:text-base">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100">
              ...
              <p className="text-gray-500 text-sm leading-relaxed italic">
                [Student testimonial from Gobichettipalayam to be added here.
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100">
              ...
              <p className="text-gray-500 text-sm leading-relaxed italic">
                [Second student testimonial from Gobichettipalayam to be added
                here. Focus on the bus route via Bhavani/hostel life and the
            ...
            <div className="rounded-2xl p-6 border-2 border-dashed border-[#7cb983] bg-[#FBFBEE] flex items-center justify-center">
              <p className="text-[#006837] text-sm font-medium text-center leading-relaxed">
                Add 2-3 real student testimonials from Gobichettipalayam or
                nearby areas before deployment.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Comparison Table */}
      <section aria-label="Comparison with Gobi-area colleges" className="bg-[#FBFBEE] py-14 sm:py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              JKKN CAS vs Local Gobi-Area Colleges
            </h2>
            <div className="mx-auto mt-4 w-12 h-1 bg-[#7cb983] rounded-full" />
          </div>
            ...
            <table className="w-full text-sm border-collapse bg-white">
              ...
              <tbody>
                ...
                <tr className="border-b border-gray-100 bg-[#FBFBEE]">
                  <td className="p-3 text-gray-600">Distance from Gobichettipalayam</td>
                  <td className="p-3 text-gray-800 font-medium">~35-40 km via Bhavani</td>
      ...
      <section id="faq-section" aria-label="Frequently asked questions" className="bg-white py-14 sm:py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 text-sm sm:text-base">
              Colleges in Gobichettipalayam — Your Questions Answered
            </p>
            <div className="mx-auto mt-4 w-12 h-1 bg-[#7cb983] rounded-full" />
          </div>
