...
export default function SalemPage() {
  const faqs = [
    ...
    },
    {
      ...
      a: "Yes. BCA graduates from JKKN CAS are placed at companies like TCS, Infosys BPO, and other IT firms. Salem's growing IT park and proximity to Coimbatore's tech corridor means BCA students have strong job prospects. The college provides placement training, aptitude coaching, and mock interviews.",
    },
    {
  ...
  return (
    <main>
      ...
      <CourseSchema
        ...
        description="3-year undergraduate commerce programme with strong industry exposure and placement support at JKKN CAS, accessible from Salem via NH-544."
        duration="PT3Y"
        educationalLevel="UG"
        category="Aided"
      ...
      <section aria-label="Hero" className="relative bg-gradient-to-br from-[#002309] via-[#006837] to-[#002309] text-white overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-20 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=cas.jkkn.ac.in&utm_medium=organic&utm_campaign=salem"
              target="_blank"
      ...
      {/* Distance Card */}
      <section aria-label="Distance from Salem" className="bg-[#FBFBEE] py-10 sm:py-12">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              UG &amp; PG Programmes Accessible from Salem
            </h2>
      ...
      <section aria-label="Placement highlights" className="bg-white py-14 sm:py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              Where Salem Graduates Are Working Now
            </h2>
            <p className="text-gray-500 text-sm sm:text-base">
              ...
              {[
                {
                  Icon: MapPin,
                  label: "ROUTE",
                  info: "NH-544 (Salem-Coimbatore Highway) — direct route",
                  bg: "bg-[#FBFBEE]",
                },
                {
                  Icon: Bus,
                  label: "BY BUS",
                  info: "TN State Transport buses from Salem New Bus Stand to Komarapalayam run every 15-20 minutes throughout the day",
                  bg: "bg-[#FBFBEE]",
                },
                {
                  Icon: Train,
                ...
                },
                {
                  ...
                  info: "Salem Airport (limited flights) / Coimbatore International Airport (~15 km / ~110 km)",
                  bg: "bg-[#FBFBEE]",
                },
                {
                  Icon: Home,
      ...
      <section className="bg-[#FBFBEE] py-14 sm:py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              Learners from Salem Love JKKN CAS
            </h2>
            <p className="text-gray-500 text-sm sm:text-base">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100">
              ...
              <p className="text-gray-500 text-sm leading-relaxed italic">
                [Learner testimonial from Salem to be added here. Include their
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100">
              ...
              <p className="text-gray-500 text-sm leading-relaxed italic">
                [Second learner testimonial from Salem to be added here. Focus
            ...
            <div className="rounded-2xl p-6 border-2 border-dashed border-[#7cb983] bg-[#FBFBEE] flex items-center justify-center">
              <p className="text-[#006837] text-sm font-medium text-center leading-relaxed">
                Add 2-3 real learner testimonials from Salem or nearby areas
                before deployment.
              </p>
            </div>
          </div>
      ...
      <section aria-label="Frequently asked questions" className="bg-white py-14 sm:py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 text-sm sm:text-base">
              Arts and Science College in Salem — Your Questions Answered
            </p>
            <div className="mx-auto mt-4 w-12 h-1 bg-[#7cb983] rounded-full" />
          </div>
