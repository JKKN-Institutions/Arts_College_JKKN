...
export const metadata: Metadata = {
  ...
  description:
    "JKKN College of Arts and Science — just 45 km from Salem via NH-544. World-class education at affordable fees with 80%+ placement support. UG programmes in Science, Commerce, BBA & BCA.",
  keywords: [
  ...
  openGraph: {
    title: "Best Arts and Science College Near Salem | JKKN CAS",
    description:
      "JKKN College of Arts and Science — just 45 km from Salem. Affordable fees, 80%+ placements, UG programmes in Science, Commerce, BBA & BCA.",
