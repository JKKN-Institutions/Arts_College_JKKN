  ...
  const faqs = [
    {
      ...
      a: "JKKN College of Arts and Science, located 22 km from Erode on NH-544, is a NAAC-accredited institution with 35 programmes and 90%+ placement rates. It is affiliated to Periyar University and approved by UGC. The college offers both UG and PG programmes across arts, science, and commerce streams.",
    },
    {
    ...
    },
    {
      ...
      a: "JKKN CAS near Erode offers BCA, BBA, B.Com, B.Sc across 8 specialisations, MCA, M.Com, M.Sc, and Ph.D programmes — 35 courses in total. All programmes are UGC-approved and affiliated to Periyar University. BCA and B.Com are the most popular among students from the Erode region.",
    },
    {
  ...
  const schemaFaqs = [
    {
      ...
      answer:
        "JKKN College of Arts and Science, located 22 km from Erode on NH-544, is a NAAC-accredited institution with 35 programmes and 90%+ placement rates. It is affiliated to Periyar University and approved by UGC.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "JKKN CAS near Erode offers BCA, BBA, B.Com, B.Sc across 8 specialisations, MCA, M.Com, M.Sc, and Ph.D programmes — 35 courses in total. All programmes are UGC-approved and affiliated to Periyar University.",
    },
    {
  ...
  return (
    <main>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "url": "https://cas.jkkn.ac.in",
            "foundingDate": "1974",
            "description": "JKKN College of Arts and Science is a NAAC-accredited institution on NH-544 near Erode, offering 34 UG, PG, and Ph.D programmes in arts, science, commerce, and computer applications, affiliated to Periyar University.",
      ...
      <CourseSchema
        ...
        description="3-year undergraduate science programme with specialisations in Chemistry, Mathematics, Zoology, Physics, Microbiology, Computer Science, and more at JKKN CAS near Erode."
        duration="PT3Y"
        educationalLevel="UG"
        category="Aided"
      ...
      <CourseSchema
        ...
        description="3-year undergraduate commerce programme with strong industry exposure and placement support at JKKN CAS, accessible from Erode via NH-544."
        duration="PT3Y"
        educationalLevel="UG"
        category="Aided"
      ...
      <section aria-label="Hero" className="relative bg-gradient-to-br from-[#002309] via-[#006837] to-[#002309] text-white overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-20 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=cas.jkkn.ac.in&utm_medium=organic&utm_campaign=erode"
              target="_blank"
      ...
      {/* Distance Card */}
      <section aria-label="Distance from Erode" className="bg-[#FBFBEE] py-10 sm:py-12">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="mt-12 pt-10 border-t border-gray-200">
            <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2 text-center">
              All 35 Programmes Available Near Erode
            </h3>
      ...
      <section aria-label="Placement highlights" className="bg-white py-14 sm:py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              Where Erode Graduates Are Working Now
            </h2>
            <p className="text-gray-500 text-sm sm:text-base">
              ...
              {[
                {
                  Icon: MapPin,
                  label: "ROUTE",
                  info: "NH-544 — direct highway connectivity",
                  bg: "bg-[#FBFBEE]",
                },
                {
                  Icon: Bus,
                  label: "BY BUS",
                  info: "Regular government and private buses from Erode Central Bus Stand to Komarapalayam available throughout the day",
                  bg: "bg-[#FBFBEE]",
                },
                {
                  Icon: Train,
      ...
      <section className="bg-[#FBFBEE] py-14 sm:py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              Learners from Erode Love JKKN CAS
            </h2>
            <p className="text-gray-500 text-sm sm:text-base">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100">
              ...
              <p className="text-gray-500 text-sm leading-relaxed italic">
                [Learner testimonial from Erode to be added here. Include their
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100">
              ...
              <p className="text-gray-500 text-sm leading-relaxed italic">
                [Second learner testimonial from Erode to be added here. Focus
            ...
            <div className="rounded-2xl p-6 border-2 border-dashed border-[#7cb983] bg-[#FBFBEE] flex items-center justify-center">
              <p className="text-[#006837] text-sm font-medium text-center leading-relaxed">
                Add 2-3 real learner testimonials from Erode or nearby areas
                before deployment.
              </p>
            </div>
          </div>
      ...
      <section id="faq-section" aria-label="Frequently asked questions" className="bg-white py-14 sm:py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 text-sm sm:text-base">
              Arts and Science College in Erode — Your Questions Answered
            </p>
            <div className="mx-auto mt-4 w-12 h-1 bg-[#7cb983] rounded-full" />
          </div>
