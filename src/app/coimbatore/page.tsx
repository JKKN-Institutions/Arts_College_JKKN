...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Best Arts and Science College Near Coimbatore | JKKN CAS",
    description:
      "JKKN CAS — 105 km from Coimbatore. NAAC-accredited, NIRF-published placement outcomes. B.Sc, B.Com, BBA, BCA. Admissions open 2026-27.",
  ...
  twitter: {
    ...
    title: "Best Arts and Science College Near Coimbatore | JKKN CAS",
    description: "JKKN CAS — 105 km from Coimbatore. NAAC-accredited, NIRF-published placement outcomes. Admissions open 2026-27.",
  },
};
    ...
    <main>
      ...
      <section aria-label="Hero" className="relative bg-gradient-to-br from-[#002309] via-[#006837] to-[#002309] text-white overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-20 text-center">
          ...
          <p className="text-base sm:text-lg text-white/80 max-w-2xl mx-auto mb-10 leading-relaxed">
            ...
            and science programmes with placement support — world-class
          ...
          <p className="aeo-citation-block text-white/70 text-sm max-w-2xl mx-auto mt-4 leading-relaxed">
            ...
            a placement record published in NIRF 2025 with recruiters including TCS, Infosys BPO, HDFC Bank, Amazon,
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              href="https://www.jkkn.ai/apply/jkkn-admission-2026?utm_source=cas.jkkn.ac.in&utm_medium=organic&utm_campaign=coimbatore"
              target="_blank"
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="font-bold text-gray-800 text-base sm:text-lg">
                  From Coimbatore to JKKN CAS
                </div>
                <div className="text-gray-500 text-sm mt-1">
                  2-2.5 hours via NH-544 (Coimbatore-Salem Highway) — direct
                  route
                </div>
              </div>
            </div>
              ...
              {[
                {
                  Icon: MapPin,
                  label: "ROUTE",
                  info: "NH-544 (Coimbatore-Salem Highway) — direct route",
                  bg: "bg-[#FBFBEE]",
                },
                {
                  Icon: Bus,
                  label: "BY BUS",
                  info: "Frequent inter-city buses from Gandhipuram and Ukkadam bus stands to Komarapalayam/Namakkal route",
                  bg: "bg-[#FBFBEE]",
                },
                {
                  Icon: Train,
                  label: "NEAREST RAILWAY STATION",
                  info: "Coimbatore Junction (~105 km from campus)",
                  bg: "bg-[#FBFBEE]",
                },
                {
                  Icon: Plane,
                  label: "NEAREST AIRPORT",
                  info: "Coimbatore International Airport (Code: CJB) (~100 km)",
                  bg: "bg-[#FBFBEE]",
                },
                {
                  Icon: Home,
      ...
      <section className="bg-[#FBFBEE] py-14 sm:py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
              Learners from Coimbatore Love JKKN CAS
            </h2>
            <p className="text-gray-500 text-sm sm:text-base">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100">
              ...
              <p className="text-gray-500 text-sm leading-relaxed italic">
                [Learner testimonial from Coimbatore to be added here. Include
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100">
              ...
              <p className="text-gray-500 text-sm leading-relaxed italic">
                [Second learner testimonial from Coimbatore to be added here.
            ...
            <div className="rounded-2xl p-6 border-2 border-dashed border-[#7cb983] bg-[#FBFBEE] flex items-center justify-center">
              <p className="text-[#006837] text-sm font-medium text-center leading-relaxed">
                Add 2-3 real learner testimonials from Coimbatore or nearby
      ...
      <section aria-label="Frequently asked questions" className="bg-[#FBFBEE] py-14 sm:py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 text-sm sm:text-base">
              Arts and Science College in Coimbatore — Your Questions Answered
            </p>
            <div className="mx-auto mt-4 w-12 h-1 bg-[#7cb983] rounded-full" />
          </div>
