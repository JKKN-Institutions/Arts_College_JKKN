        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_0.85fr] gap-4 sm:gap-6 lg:gap-12 items-center">
          ...
          <div className="flex flex-col space-y-3 sm:space-y-4 lg:space-y-5">
            ...
            <div className="grid grid-cols-4 gap-2 sm:gap-3" data-speakable>
              ...
              {/* Stat 2 */}
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-lg p-2 sm:p-3 text-center hover:bg-white/15 transition-all duration-300 hover:scale-105" aria-label="1685 learners enrolled">
                <div className="text-brand-yellow text-lg sm:text-xl lg:text-2xl font-bold mb-0.5">1,685</div>
              ...
              {/* Stat 4 */}
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-lg p-2 sm:p-3 text-center hover:bg-white/15 transition-all duration-300 hover:scale-105" aria-label="college established in 1974">
                <div className="text-brand-yellow text-lg sm:text-xl lg:text-2xl font-bold mb-0.5">1974</div>
                <div className="text-white/80 text-[9px] sm:text-[10px] font-medium">Established</div>
              </div>
            </div>
